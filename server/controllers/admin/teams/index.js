...
router.get(
    ...
    async (req, res) => {
      try {
        ...
        if (userData.inviteToken) return res.status(201).json({ success: "Team Admin has already accepted the invite" });
        ...
        Please <a href='${config.get("URL")}/invite/verify/${token}'>Click Here </a>
